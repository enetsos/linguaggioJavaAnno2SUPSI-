...
class DigitalJukeBox extends JukeBox {
    private final List<DigitalMedia> digitalMedias;

    DigitalJukeBox(List<DigitalMedia> digitalMedias) {
...
class AnalogJukeBox extends JukeBox {
    ...
    public AnalogJukeBox(List<Vinyl> vinyls) {
        this.vinyls = vinyls;
    }
...
public class JukeBoxExample {
    public static void main(String[] args) {
        ...
        List<Vinyl> vinyls33 = new ArrayList<Vinyl>();
        ...
        List<Vinyl> vinyls45 = new ArrayList<Vinyl>();
